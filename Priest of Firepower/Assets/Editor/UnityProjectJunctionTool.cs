...
public static class UnityProjectJunctionTool
{
	...
	private static void CreateJunctionUnityProject()
	{
        ...
        string junctionProjectsFolderName = "Junction Projects";
        string junctionProjectsFolderPath = Path.Combine(desktopPath, junctionProjectsFolderName);

        if (!Directory.Exists(junctionProjectsFolderPath))
        {
            Directory.CreateDirectory(junctionProjectsFolderPath);
		...
		string junctionPath = Path.Combine(junctionProjectsFolderPath, junctionDirectory);
		...
		if (Directory.Exists(junctionPath))
		{
			...
			else
			{
				...
				do
				{
					...
					junctionPath = Path.Combine(junctionProjectsFolderPath, junctionDirectory);
